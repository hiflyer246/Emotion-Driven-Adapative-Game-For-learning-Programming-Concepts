...
import { Code, Brain, Trophy, ArrowRight, LogOut, BarChart3, Mic } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {TOPICS.map((topic) => (
                      <Badge
                        ...
                        className={`cursor-pointer capitalize ${selectedTopic === topic
                  ...
                  <div className="flex gap-2">
                    {Object.values(DIFFICULTIES).map((difficulty) => (
                      <Badge
                        ...
                        className={`cursor-pointer capitalize ${selectedDifficulty === difficulty
            ...
            <Card className="p-8 space-y-6 border-2 border-blue-500/20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Practice voice-based technical interviews</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-gray-400 space-y-1 ml-4 list-disc">
                    ...
                    <li>Voice-to-Text Responses</li>
                  </ul>
                </div>
                <div className="flex items-center justify-end">
                  <Button
                    onClick={() => navigate('/interviews')}
                    className="w-full h-full bg-blue-600 hover:bg-blue-700 text-white font-bold"
                  >
                    Go to Dashboard
                  </Button>
                </div>
